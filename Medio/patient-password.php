...
<input type="password" class="form-control floating pass-icon" required="">
</div>
</div>
</div>
<div class="col-lg-12">
...
<input type="password" class="form-control floating pass-icon-1" required="">
</div>
</div>
</div>
</div>
...
<div class="modal fade fade-custom" id="patient-verified" tabindex="-1" aria-hidden="true">
...
<a href="patient-Personalize.html">Continue</a>
</div>
</div>
</div>
</div>
...
<script src="assets/js/bootstrap.bundle.min.js" type="f168afbca874b02d240500e7-text/javascript"></script>

<script src="assets/js/jquery-3.6.0.min.js" type="f168afbca874b02d240500e7-text/javascript"></script>

<script src="assets/js/owl.carousel.min.js" type="f168afbca874b02d240500e7-text/javascript"></script>

<script src="assets/js/script.js" type="f168afbca874b02d240500e7-text/javascript"></script>
<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="f168afbca874b02d240500e7-|49" defer=""></script></body>
</html>