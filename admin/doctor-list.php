...
<li><a href="cms.php">Users Report</a></li>
</ul>
</li>
<li class="menu-title">
<span>Pharmacy</span>
...
<div class="doc-badge me-3">Doctors </div>
<div class="SortBy">
...
<a href='#' data-bs-target='#patientlist' data-bs-toggle='modal'><img class='avatar avatar-img' src='uploads/".$row['profile']."' alt='User Image'></a>
...
<td><span class='user-name'>".$row['specialization']." </span><span class='d-block'></span></td>
<td><span class='user-name'>".$row['DOB']." </span><span class='d-block'></span></td>
<td>
<label class='toggle-switch' for='status7'>
<span class='text-muted'>".$row['numbers']."</span>
...
<a href='includes/activate.php?title=".$row['id']."' onclick='return showPopup1()'  class='btn btn-sm bg-success-light'>
 activate
</a>
<a href='includes/deactive.php?title=".$row['id']."' onclick='return showPopup2()'  class='btn btn-sm bg-danger-light'>
 deactivate
</a>
<a href='includes/delp.php?title=".$row['id']."' onclick='return showPopup()'  class='btn btn-sm bg-danger-light'>
 delete
</a>
</span>
</label>
 ...
 <script>
    function showPopup1() {
      if (confirm("are you sure you want to activate doctor?")) {
      ...
      function showPopup2() {
      if (confirm("are you sure you want to deactivate doctor?")) {
        return true;  // User clicked "OK", so proceed to new page
      } else {
        return false;  // User clicked "Cancel", so stay on current page
      }
...
<div class="card">
 <div class="container">
  <form action="includes/drsignup.inc.php" method="POST" class="mx-auto">
...
<input name="cpassword" type="password" placeholder="confirm" class="form-control">
...
<div class="mem-info">
<h6>Email ID</h6>
<p><a href="https://template.doccure.io/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="80c4efe3f4eff2c0c4efe3e3f5f2e5aee3efed">[email&#160;protected]</a></p>
</div>
</div>
</div>
</div>
...
<script data-cfasync="false" src="../../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-3.6.0.min.js" type="fc5efca3fc852fe921a19b2e-text/javascript"></script>

<script src="assets/js/bootstrap.bundle.min.js" type="fc5efca3fc852fe921a19b2e-text/javascript"></script>

<script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="fc5efca3fc852fe921a19b2e-text/javascript"></script>

<script src="assets/plugins/datatables/jquery.dataTables.min.js" type="fc5efca3fc852fe921a19b2e-text/javascript"></script>
<script src="assets/plugins/datatables/datatables.min.js" type="fc5efca3fc852fe921a19b2e-text/javascript"></script>

<script src="assets/js/moment.min.js" type="fc5efca3fc852fe921a19b2e-text/javascript"></script>
<script src="assets/plugins/daterangepicker/daterangepicker.js" type="fc5efca3fc852fe921a19b2e-text/javascript"></script>

<script src="assets/plugins/select2/js/select2.min.js" type="fc5efca3fc852fe921a19b2e-text/javascript"></script>

<script src="assets/js/script.js" type="fc5efca3fc852fe921a19b2e-text/javascript"></script>
<script src="../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="fc5efca3fc852fe921a19b2e-|49" defer=""></script></body>
