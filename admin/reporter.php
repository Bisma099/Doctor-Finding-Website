...
<div class="media-body">
<h6>dr.Ali <span class="notification-time">8.30 AM</span></h6>
...
$sql="SELECT * FROM doctor WHERE username LIKE '%$name%';";
...
<a href='checked.php?title=".$row['id']."' onclick='return showPopup()'  class='btn btn-sm bg-success-light'>
 check
</a>
</span>
</label>
...
<a href='check.php?title=".$row['id']."' onclick='return showPopup()'  class='btn btn-sm bg-success-light'>
 check
</a>
</span>
</label>
...
<label>type </label>
<select name="type" type="text" placeholder="category" class="form-control">
