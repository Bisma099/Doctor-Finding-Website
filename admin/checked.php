...
// Specify the user ID to retrieve data for
$id = $_GET['title'];


// Construct the SQL query to sum the "amount" columns
$sql = "SELECT SUM(amount) as total_amount FROM trds WHERE drid=$id;";
...
// Construct the SQL query to sum the "amount" columns
$sql = "SELECT SUM(amount) as total_amount FROM trc WHERE userid=$id;";
...
$sql="SELECT * FROM bookedapt WHERE drid=$id;";
$result=mysqli_query($conn,$sql);
$queryresult=mysqli_num_rows($result);
...
$sql="SELECT * FROM trc WHERE userid=$id;";
$result=mysqli_query($conn,$sql);
$queryresult=mysqli_num_rows($result);
