...
<p class="noti-details"> has booked her appointment to <span class="noti-title">Dr. Sara</span></p>
</div>
</div>
</a>
</li>
...
<p class="noti-details"> Sent a amount 210 for his Appointment <span class="noti-title">Dr.Ali</span></p>
</div>
</div>
</a>
</li>
...
$sql="SELECT * FROM doctor_reviews ;";
...
<a href='#' data-bs-target='#patientlist' data-bs-toggle='modal'><span class='user-name'>".$row['doctor_name']."</span> <span class='text-muted'>".$row['drid']."</span></a>
</h2>
</td>
<td><span class='user-name'>".$row['patient']." </span><span class='d-block'></span></td>
<td><span class='user-name'>".$row['title']." </span><span class='d-block'></span></td>
<td>
<label class='toggle-switch' for='status7'>
<span class='text-muted'>".$row['reviews']."</span>
...
");
   ...
   echo ("<td><div class='review-count rating'> ");
    for ($i = 1; $i <= 5; $i++) {
      if ($i <= $row["rating"]) {
...
");
    ...
    echo ("</div></td>");
         echo("<td>
<a href='includes/revactive.php?title=".$row['id']."'  onclick='return showPopup1()'  class='btn btn-sm bg-success-light'>
 activate
</a>
<a href='includes/revinactive.php?title=".$row['id']."'  onclick='return showPopup2()'  class='btn btn-sm bg-danger-light'>
 deactivate
</a>
<a href='includes/revdeld.php?title=".$row['id']."'  onclick='return showPopup()' class='btn btn-sm bg-danger-light'>
 delete
</a>
</span>
</label>
