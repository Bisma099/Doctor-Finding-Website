...
<div class="row align-items-center">
<div class="col">
<h5 class="card-title">Doctor Cnic</h5>
</div>
...
<a href='#' data-bs-target='#patientlist' data-bs-toggle='modal'><img class='avatar'  src='uploads/".$row['cnic']."' alt='User Image'></a>
<a href='#' data-bs-target='#patientlist' data-bs-toggle='modal'><span class='user-name'>".$row['nicn']."</span> 
</h2>
</td>
<td><span class='user-name'>".$row['fname']." </span><span class='d-block'></span></td>
<td><span class='user-name'>".$row['name']." </span><span class='d-block'></span></td>
...
<a href='includes/cnicactivate.php?title=".$row['drid']."' onclick='return showPopup()'   class='btn btn-sm bg-success-light'>
 approve
</a>
<a href='includes/deactivecnic.php?title=".$row['drid']."' onclick='return showPopup()'   class='btn btn-sm bg-danger-light'>
 disapprove
</a>
...
<div id="tablepagination" class="dataTables_wrapper"></div>
 ...
 <script>
      ...
      function showPopup() {
      if (confirm("are you sure you want to make the following cnic changes")) {
