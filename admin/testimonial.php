...
<a href='#' data-bs-target='#patientlist' data-bs-toggle='modal'><img class='avatar'  src='upload/".$row['username']."' alt='User Image'></a>
<a href='#' data-bs-target='#patientlist' data-bs-toggle='modal'><span class='user-name'>".$row['pprofile']."</span> 
</h2>
</td>
<td><span class='user-name'>".$row['testimony']." </span><span class='d-block'></span></td>

<td><span class='user-name'>".$row['status']." </span><span class='d-block'></span></td>
<td>

<a href='includes/testimony.php?title=".$row['id']."'  class='btn btn-sm bg-success-light'>
 approve
</a>
<a href='includes/cancel.php?cancel=".$row['id']."'  class='btn btn-sm bg-danger-light'>
 disapprove
</a>
